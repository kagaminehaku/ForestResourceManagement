...
namespace ForestResourceManagement.MixForm.QLHuyenXa
{
    public class XaForm : Form
    {
        ...
        public XaForm(XaTable xa = null)
        {
            ...
            var label = new Label { Text = "Tên Xã:", AutoSize = true, Location = new Point(10, 20) };
            var textBox = new TextBox { Text = Xa.TenXa, Location = new Point(10, 45), Size = new Size(200, 20) };
